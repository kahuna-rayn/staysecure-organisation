      ...
      /* @__PURE__ */ jsxs("form", { onSubmit, className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
            ...
            /* @__PURE__ */ jsxs(Select, { value: newUser.status, onValueChange: (value) => updateField("status", value), children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsx(Label, { htmlFor: "access_level", children: "Access Level" }),
            /* @__PURE__ */ jsxs(Select, { value: newUser.access_level, onValueChange: (value) => updateField("access_level", value), children: [
              /* @__PURE__ */ jsx(SelectTrigger, { children: /* @__PURE__ */ jsx(SelectValue, {}) }),
              /* @__PURE__ */ jsxs(SelectContent, { children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          ...
          /* @__PURE__ */ jsxs(Select, { value: newUser.location_id || "", onValueChange: handleLocationChange, children: [
    ...
    /* @__PURE__ */ jsxs(DialogContent, { className: "max-w-3xl max-h-[90vh] overflow-y-auto", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-blue-50 border border-blue-200 rounded-lg p-4", children: [
          /* @__PURE__ */ jsx("h4", { className: "font-semibold text-blue-900 mb-2", children: "Required Columns" }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "text-sm text-blue-800 space-y-1", children: [
            ...
            /* @__PURE__ */ jsx("p", { children: "• Roles and departments can be assigned after bulk import" }),
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsx("h2", { className: "text-xl font-semibold", children: "User Management" }),
    ...
    /* @__PURE__ */ jsxs(Card, { children: [
      ...
      /* @__PURE__ */ jsxs(CardContent, { children: [
        /* @__PURE__ */ jsxs(Table, { children: [
          /* @__PURE__ */ jsx(TableHeader, { children: /* @__PURE__ */ jsxs(TableRow, { children: [
            /* @__PURE__ */ jsx(TableHead, { children: "Name" }),
            /* @__PURE__ */ jsx(TableHead, { children: "Building" }),
...
const OrganisationProfile = () => {
  ...
  const fetchOrganisationData = async () => {
    try {
      setLoading(true);
      const { data: orgProfile, error: orgError } = await supabase.from("org_profile").select("*").maybeSingle();
      if (orgError) {
        throw orgError;
      }
      if (orgProfile) {
      ...
      const { data: sigRoles, error: sigError } = await supabase.from("org_sig_roles").select("*");
      if (sigError) {
        throw sigError;
      }
  ...
  const handleSave = async () => {
    try {
      setSaving(true);
      const { error: orgError } = await supabase.from("org_profile").upsert(organisationData);
      ...
      for (const update of updates) {
        const { error: sigError } = await supabase.from("org_sig_roles").upsert(update, { onConflict: "role_type" });
  ...
  const fetchUserEmailAndRole = async (userId) => {
    var _a;
    try {
      const { data: emailData, error: emailError } = await supabase.rpc("get_user_email_by_id", { user_id: userId });
      if (emailError) {
        console.error("Error fetching user email:", emailError);
        return { email: "", title: "" };
      }
      const { data: roleData, error: roleError } = await supabase.from("user_profile_roles").select(`
          roles(name)
  ...
  return /* @__PURE__ */ jsx(Card, { className: "w-full", children: /* @__PURE__ */ jsxs(CardContent, { className: "p-6", children: [
    /* @__PURE__ */ jsxs(Tabs, { defaultValue: "departments", className: "w-full", children: [
      /* @__PURE__ */ jsxs(TabsList, { className: `grid w-full ${getGridClass()} mb-6`, children: [
        ...
        (profile == null ? void 0 : profile.enrolled_in_learn) && /* @__PURE__ */ jsxs(TabsTrigger, { value: "learn", className: "flex items-center gap-2", children: [
      ...
      (profile == null ? void 0 : profile.enrolled_in_learn) && /* @__PURE__ */ jsx(TabsContent, { value: "learn", className: "space-y-4 animate-fade-in", children: /* @__PURE__ */ jsx(LearningTracksTab, { userId: profile.id }) })
    ] }),
    /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx(
