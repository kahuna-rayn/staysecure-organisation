...
const PersonaDetailsTabs = ({ profile, userId, onUpdate }) => {
  ...
  return /* @__PURE__ */ jsx(Card, { className: "w-full", children: /* @__PURE__ */ jsxs(CardContent, { className: "p-6", children: [
    /* @__PURE__ */ jsxs(Tabs, { defaultValue: isLearnMode ? "certification" : "knowledge", className: "w-full", children: [
      ...
      !isLearnMode && (profile == null ? void 0 : profile.cyber_learner) && /* @__PURE__ */ jsx(TabsContent, { value: "learn", className: "space-y-4 animate-fade-in", children: /* @__PURE__ */ jsx(LearningTracksTab, { userId: typeof profile.id === "string" ? profile.id : userId }) })
    ] }),
    !isLearnMode && /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx(
