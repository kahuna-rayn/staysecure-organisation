(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("react/jsx-runtime"), require("react"), require("@/components/ui/card"), require("@/components/ui/tabs"), require("@/components/ui/badge"), require("@/hooks/useUserProfiles"), require("@/hooks/useUserManagement"), require("@/hooks/useViewPreference"), require("@/integrations/supabase/client"), require("@/components/ui/use-toast"), require("@/components/ui/toggle-group"), require("@/components/ui/delete-user-dialog"), require("@/hooks/use-toast"), require("react-router-dom"), require("@tanstack/react-query"), require("@/components/ui/button"), require("@/components/ui/avatar"), require("@/modules/organisation/components/profile/EditableField"), require("@/components/admin/DepartmentRolePairsDisplay"), require("@/components/ui/editable-table"), require("@/components/ui/dialog"), require("@/components/ui/input"), require("@/components/ui/label"), require("@/components/ui/select"), require("@/components/ui/textarea"), require("react-dropzone"), require("papaparse"), require("@/components/import/ImportErrorReport"), require("@/components/ui/table"), require("@/components/ui/switch"), require("@/components/ui/separator"), require("react-dom"), require("@/lib/utils"), require("@/components/ui/command"), require("@/components/ui/popover"), require("@/modules/organisation"), require("@/hooks/useUserRole"), require("@/components/HardwareInventory"), require("@/components/SoftwareAccounts"), require("@/components/EditableCertificates"), require("@/components/PhysicalLocationTab"), require("@/components/admin/AssignHardwareDialog"), require("@/components/admin/AssignSoftwareDialog"), require("@/components/admin/AddEducationDialog"), require("@/components/knowledge/MyDocuments"), require("@/components/admin/UserDepartmentsRolesManager"), require("@/components/LearningTracksTab"), require("@/hooks/useUserDepartments"), require("@/hooks/useUserProfileRoles"), require("@/hooks/useUserPhysicalLocations"), require("@/modules/organisation/components/profile/ProfileAvatar"), require("@/modules/organisation/components/profile/ProfileContactInfo"), require("@/hooks/useProfile"), require("@/hooks/useUserAssets"), require("@/modules/organisation/components/EditableProfileHeader"), require("@/modules/organisation/components/PersonaDetailsTabs"), require("@/hooks/useUserRoleById")) : typeof define === "function" && define.amd ? define(["exports", "react/jsx-runtime", "react", "@/components/ui/card", "@/components/ui/tabs", "@/components/ui/badge", "@/hooks/useUserProfiles", "@/hooks/useUserManagement", "@/hooks/useViewPreference", "@/integrations/supabase/client", "@/components/ui/use-toast", "@/components/ui/toggle-group", "@/components/ui/delete-user-dialog", "@/hooks/use-toast", "react-router-dom", "@tanstack/react-query", "@/components/ui/button", "@/components/ui/avatar", "@/modules/organisation/components/profile/EditableField", "@/components/admin/DepartmentRolePairsDisplay", "@/components/ui/editable-table", "@/components/ui/dialog", "@/components/ui/input", "@/components/ui/label", "@/components/ui/select", "@/components/ui/textarea", "react-dropzone", "papaparse", "@/components/import/ImportErrorReport", "@/components/ui/table", "@/components/ui/switch", "@/components/ui/separator", "react-dom", "@/lib/utils", "@/components/ui/command", "@/components/ui/popover", "@/modules/organisation", "@/hooks/useUserRole", "@/components/HardwareInventory", "@/components/SoftwareAccounts", "@/components/EditableCertificates", "@/components/PhysicalLocationTab", "@/components/admin/AssignHardwareDialog", "@/components/admin/AssignSoftwareDialog", "@/components/admin/AddEducationDialog", "@/components/knowledge/MyDocuments", "@/components/admin/UserDepartmentsRolesManager", "@/components/LearningTracksTab", "@/hooks/useUserDepartments", "@/hooks/useUserProfileRoles", "@/hooks/useUserPhysicalLocations", "@/modules/organisation/components/profile/ProfileAvatar", "@/modules/organisation/components/profile/ProfileContactInfo", "@/hooks/useProfile", "@/hooks/useUserAssets", "@/modules/organisation/components/EditableProfileHeader", "@/modules/organisation/components/PersonaDetailsTabs", "@/hooks/useUserRoleById"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.OrganisationManagement = {}, global["react/jsx-runtime"], global.React, global.card, global.tabs, global.badge, global.useUserProfiles, global.useUserManagement, global.useViewPreference, global.client, global.useToast, global.toggleGroup, global.deleteUserDialog, global.useToast$1, global.ReactRouterDOM, global.ReactQuery, global.button, global.avatar, global.EditableField$1, global.DepartmentRolePairsDisplay, global.editableTable, global.dialog, global.input, global.label, global.select, global.textarea, global.reactDropzone, global.Papa, global.ImportErrorReport, global.table, global._switch, global.separator, global.ReactDOM, global.utils, global.command, global.popover, global.organisation, global.useUserRole, global.HardwareInventory, global.SoftwareAccounts, global.EditableCertificates, global.PhysicalLocationTab, global.AssignHardwareDialog, global.AssignSoftwareDialog, global.AddEducationDialog, global.MyDocuments, global.UserDepartmentsRolesManager, global.LearningTracksTab, global.useUserDepartments, global.useUserProfileRoles, global.useUserPhysicalLocations, global.ProfileAvatar$1, global.ProfileContactInfo$1, global.useProfile, global.useUserAssets, global.EditableProfileHeader$1, global.PersonaDetailsTabs$1, global.useUserRoleById));
})(this, function(exports2, jsxRuntime, o, card, tabs, badge, useUserProfiles, useUserManagement, useViewPreference, client, useToast, toggleGroup, deleteUserDialog, useToast$1, reactRouterDom, reactQuery, button, avatar, EditableField$1, DepartmentRolePairsDisplay, editableTable, dialog, input, label, select, textarea, reactDropzone, Papa, ImportErrorReport, table, _switch, separator, vt, utils, command, popover, organisation, useUserRole, HardwareInventory, SoftwareAccounts, EditableCertificates, PhysicalLocationTab, AssignHardwareDialog, AssignSoftwareDialog, AddEducationDialog, MyDocuments, UserDepartmentsRolesManager, LearningTracksTab, useUserDepartments, useUserProfileRoles, useUserPhysicalLocations, ProfileAvatar$1, ProfileContactInfo$1, useProfile, useUserAssets, EditableProfileHeader$1, PersonaDetailsTabs$1, useUserRoleById) {
  "use strict";
  /**
      ...
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-start justify-between mb-3", children: [
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx("div", { className: "text-sm text-muted-foreground", children: /* @__PURE__ */ jsxRuntime.jsx(DepartmentRolePairsDisplay.DepartmentRolePairsDisplay, { userId: user.id }) })
          ] })
        ] }),
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(card.Card, { className: "w-full", children: /* @__PURE__ */ jsxRuntime.jsxs(card.CardContent, { className: "p-6", children: [
      /* @__PURE__ */ jsxRuntime.jsxs(tabs.Tabs, { defaultValue: "departments", className: "w-full", children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(tabs.TabsContent, { value: "departments", className: "space-y-4 animate-fade-in", children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(UserDepartmentsRolesManager.UserDepartmentsRolesManager, { userId, ref: departmentRolesRef })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
