...
import { UserRoleField as UserRoleField$1 } from "@/modules/organisation/components/profile/UserRoleField";
/**
...
const ProfileContactInfo = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-end space-y-3 ml-auto", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "flex items-center justify-end gap-2 text-sm", children: /* @__PURE__ */ jsx(UserRoleField$1, { userId }) }),
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-sm", children: [
      /* @__PURE__ */ jsx(Calendar, { className: "h-4 w-4 text-muted-foreground" }),
