...
import MyDocuments$1 from "@/components/knowledge/MyDocuments";
  ...
  return /* @__PURE__ */ jsx(Card, { className: "w-full", children: /* @__PURE__ */ jsxs(CardContent, { className: "p-6", children: [
    /* @__PURE__ */ jsxs(Tabs, { defaultValue: "knowledge", className: "w-full", children: [
      ...
      isLearnMode ? /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx(TabsContent, { value: "knowledge", className: "space-y-4 animate-fade-in", children: /* @__PURE__ */ jsx(MyDocuments$1, { userId: typeof profile.id === "string" ? profile.id : userId }) }),
...
const DocumentAssignmentsDrillDown = ({
  ...
  const renderBreadcrumb = () => /* @__PURE__ */ jsx("div", { className: "flex items-center gap-2 mb-6", children: drillDownPath.map((level, index) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
    ...
    index < drillDownPath.length - 1 && /* @__PURE__ */ jsx(ChevronRight, { className: "h-4 w-4" })
  ] }, index)) });
  const renderContent = () => {
    ...
    if (currentLevel.type === "org") {
      ...
      return /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h2", { className: "text-lg font-semibold mb-2", children: "Organization Level" }),
        /* @__PURE__ */ jsx(Card, { className: "mb-6 w-1/2", children: /* @__PURE__ */ jsxs(CardHeader, { children: [
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
            /* @__PURE__ */ jsxs(CardTitle, { className: "flex items-center", children: [
              /* @__PURE__ */ jsx(Building, { className: "mr-2 h-5 w-5" }),
              "Organization Overview"
            ] }),
            /* @__PURE__ */ jsx("div", { className: "text-3xl font-bold text-blue-600", children: overallValue })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Total assigned staff" })
        ] }) }),
        /* @__PURE__ */ jsx("h2", { className: "text-lg font-semibold mb-4", children: "Location" }),
        renderLocationLevel()
      ] });
    }
      ...
      return /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx(Card, { className: "mb-6 w-1/2", children: /* @__PURE__ */ jsxs(CardHeader, { children: [
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "text-3xl font-bold text-blue-600", children: locationValue })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Total for this location" })
        ] }) }),
        /* @__PURE__ */ jsx("h2", { className: "text-lg font-semibold mb-4", children: "Departments" }),
        (() => {
          ...
          return /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4", children: locationDepartments.map((departmentName) => {
      ...
      return /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx(Card, { className: "mb-6 w-1/2", children: /* @__PURE__ */ jsxs(CardHeader, { children: [
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "text-3xl font-bold text-blue-600", children: departmentValue })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Total for this department" })
        ] }) }),
        /* @__PURE__ */ jsx("h2", { className: "text-lg font-semibold mb-4", children: "Staff" }),
        renderStaffList()
      ] });
    }
  ...
  const renderLocationLevel = () => {
    const currentLevel = drillDownPath[drillDownPath.length - 1];
    const overviewCard = /* @__PURE__ */ jsxs(Card, { className: "mb-6", children: [
...
const MyDocuments = ({ userId }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxs(Tabs, { value: activeTab, onValueChange: setActiveTab, children: [
      ...
      /* @__PURE__ */ jsx(TabsContent, { value: "assigned", className: "space-y-4", children: /* @__PURE__ */ jsx(DocumentList, { assignments: filteredAssignments || [], onStatusChange: handleStatusChange }) }),
      /* @__PURE__ */ jsx(TabsContent, { value: "required", className: "space-y-4", children: /* @__PURE__ */ jsx(DocumentList, { assignments: requiredAssignments || [], onStatusChange: handleStatusChange }) }),
      /* @__PURE__ */ jsx(TabsContent, { value: "optional", className: "space-y-4", children: /* @__PURE__ */ jsx(DocumentList, { assignments: optionalAssignments || [], onStatusChange: handleStatusChange }) })
    ] })
  ] });
};
const DocumentList = ({ assignments, onStatusChange }) => {
  const getStatusIcon = (status) => {
    switch (status) {
      ...
      default:
        return /* @__PURE__ */ jsx(CircleAlert, { className: "h-4 w-4 text-orange-500" });
    }
  };
  const getStatusColor = (status) => {
    switch (status) {
